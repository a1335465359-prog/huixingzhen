...
This repo includes `vercel.json` so Vercel serves static assets from `docs/`:

- `/` -> `docs/index.html`
- `/<path>` -> `docs/<path>`

You can deploy directly by importing this repository in Vercel without additional build settings.
